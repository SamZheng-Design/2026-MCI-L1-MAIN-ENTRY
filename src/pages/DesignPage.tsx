...
export const DesignPage: FC = () => {
  return (
    <div class="min-h-screen">
      ...
      {/* Hero Section */}
      <section class="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-primary/5 pt-16 pb-20">
        <div class="absolute inset-0 dot-pattern opacity-30"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div class="text-center fade-in">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/10 text-primary text-xs font-medium rounded-full mb-6">
              <i class="fas fa-diagram-project"></i>
              Super Agent Architecture
            </div>
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              核心架构：9个核心<span class="text-primary">"通"</span>与统一底座
            </h1>
                    ...
                    <div class="card-hover bg-white border border-gray-200 rounded-xl p-4 cursor-pointer" onclick={`window.location.href='/${p.id}'`}>
                      <div class="flex items-start gap-3">
                        <img
                          src={p.logo}
                          alt={p.name}
                          class="w-12 h-12 rounded-lg logo-hover object-cover flex-shrink-0"
                          loading="lazy"
                        />
                        <div class="flex-1 min-w-0">
                          ...
                          <p class="text-xs text-gray-500 leading-relaxed">{p.description.slice(0, 20)}...</p>
                        </div>
                      </div>
      ...
      <section class="py-8 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 text-center">
          ...
          <div class="mt-4 flex justify-center gap-2">
            {[1,2,3,4,5].map(() => (
              <div class="w-1.5 h-1.5 rounded-full bg-primary/30 animate-pulse"></div>
            ))}
          </div>
        </div>
      </section>
      ...
      <section class="py-16 bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="relative border-t-4 border-primary rounded-xl bg-white shadow-lg overflow-hidden">
                ...
                {foundations.map((f) => (
                  <div class="card-hover bg-gray-50 rounded-xl p-6 text-center border border-gray-100">
                    <div class="w-14 h-14 mx-auto mb-4 rounded-2xl bg-primary/10 flex items-center justify-center">
                      <i class={`fas ${f.icon} text-2xl text-primary`}></i>
                    </div>
          ...
          <div class="relative">
            ...
            <div class="flex justify-center mb-6">
              <div class="bg-blue-50 border-2 border-blue-300 rounded-xl px-6 py-3 text-center shadow-sm">
                <img src={products[0].logo} alt="Identity" class="w-10 h-10 mx-auto mb-1 rounded-lg" loading="lazy" />
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-center">
                  <div class="bg-blue-50 border border-blue-200 rounded-xl px-4 py-2.5 text-center card-hover">
                    <img src={products[1].logo} alt="Application" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-center">
                  <div class="bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-2.5 text-center card-hover">
                    <img src={products[2].logo} alt="Opportunity" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
            ...
            <div class="flex justify-center mb-4">
              <div class="flex items-center gap-4">
                ...
                <div class="bg-indigo-50 border-2 border-indigo-300 rounded-xl px-5 py-3 text-center shadow-sm">
                  <img src={products[3].logo} alt="Assess" class="w-10 h-10 mx-auto mb-1 rounded-lg" loading="lazy" />
            ...
            <div class="flex justify-center mb-4">
              <div class="bg-indigo-50 border border-indigo-200 rounded-xl px-5 py-3 text-center card-hover">
                <img src={products[4].logo} alt="Risk" class="w-10 h-10 mx-auto mb-1 rounded-lg" loading="lazy" />
            ...
            {/* Arrow down */}
            <div class="flex justify-center mb-4"><i class="fas fa-arrow-down text-primary text-lg"></i></div>

            {/* Terms + Contract */}
            <div class="flex justify-center gap-6 mb-4">
              <div class="bg-purple-50 border border-purple-200 rounded-xl px-4 py-2.5 text-center card-hover">
                <img src={products[5].logo} alt="Terms" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
              ...
              <div class="bg-purple-50 border border-purple-200 rounded-xl px-4 py-2.5 text-center card-hover">
                <img src={products[6].logo} alt="Contract" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
            ...
            <div class="flex justify-center gap-6">
              <div class="bg-green-50 border border-green-200 rounded-xl px-4 py-2.5 text-center card-hover">
                <img src={products[7].logo} alt="Performance" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
                <div class="text-xs font-bold text-green-700">履约通</div>
              </div>
              <div class="flex items-center"><i class="fas fa-arrow-right text-gray-300"></i></div>
              <div class="bg-green-50 border border-green-200 rounded-xl px-4 py-2.5 text-center card-hover">
                <img src={products[8].logo} alt="Settlement" class="w-8 h-8 mx-auto mb-1 rounded-lg" loading="lazy" />
      ...
      {/* CTA Section */}
      <section class="py-16 bg-gradient-to-br from-primary/5 via-white to-primary/10">
        <div class="max-w-4xl mx-auto px-4 text-center">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/portal"
              class="inline-flex items-center justify-center px-8 py-3.5 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 no-underline"
            >
              <i class="fas fa-rocket mr-2"></i>进入产品入口
            </a>
            <a
              href="#"
              class="inline-flex items-center justify-center px-8 py-3.5 bg-white text-gray-700 font-semibold rounded-xl border border-gray-200 hover:border-primary hover:text-primary transition-all no-underline"
            >
