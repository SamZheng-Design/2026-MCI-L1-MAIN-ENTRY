 ...
 * 2. News List — 4条新闻卡片(日期/分类/标题/摘要/阅读全文链接)
 *    - 2026-02-25: 9个Agent产品矩阵正式开放商用
 *    - 2026-02-18: 与多家国际资管机构达成战略合作
 *    - 2026-02-10: AI筛选引擎升级
 *    - 2026-01-28: RBF 2026行业趋势展望
 * 3. Subscribe — 订阅CTA + 联系链接
 *
 * 注意: 当前为Demo数据，新闻链接为占位符(#)
 */
